...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210411_sportsrulz_7851669341da0e076932_20210411064813_archive.zip';
	const ARCHIVE_SIZE		 = '22711616';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '7851669-11064813';
    const SECONDARY_PACKAGE_HASH = 'e87ef74-11064813';
	const VERSION			 = '1.4.0';
